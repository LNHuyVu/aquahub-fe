...
function MarketplaceContent() {
  ...
  const updateFilters = (newParams: Record<string, string | null>) => {
    ...
    router.push(`/cho-thuy-sinh?${params.toString()}`);
  };
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-6 space-y-4 sm:space-y-6">
      {/* HERO BANNER - Synchronized with all pages */}
      <div className="bg-gradient-to-r from-[#1A94FF] via-[#0B74E5] to-[#0D5CB6] rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 text-white shadow-lg shadow-blue-500/10 space-y-4 sm:space-y-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            ...
            <Link
              href="/cho-thuy-sinh/tin-cua-toi"
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-3xl border border-slate-200 shadow-sm">
            ...
            <button
              onClick={() => router.push('/cho-thuy-sinh')}
