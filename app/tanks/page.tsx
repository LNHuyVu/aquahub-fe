...
import { ChevronLeft, ChevronRight, Layers, Plus, User as UserIcon } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {loading ? (
          ...
          currentTanks.map((tank) => (
            <div key={tank.id} className="bg-white border border-blue-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md hover:border-blue-300 transition flex flex-col">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500 font-medium">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <option value={50}>50 hồ (Tất cả)</option>
              </select>
            </div>
          </div>
